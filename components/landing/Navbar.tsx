        ...
        <nav className="sticky top-0 z-50 border-b border-[#eee9f1] dark:border-gray-800 bg-surface-light/90 dark:bg-background-dark/90 backdrop-blur-md">
            <div className="mx-auto max-w-[1280px] px-6 py-4">
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-3">
                        {user ? (
                            <Link href="/dashboard" className="flex items-center justify-center rounded-xl bg-primary hover:bg-primary-dark text-white text-sm font-bold h-10 px-5 transition-all shadow-md hover:shadow-lg">
                                Dashboard
                            </Link>
                        ) : (
                            <>
